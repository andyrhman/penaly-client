  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        setPosts(post);
        setDisplayedPosts(post.slice(0, postsPerPage)); // Show the first 6 posts initially
      } catch (error) {
          ...
          {loading ?
            ...
            <>
              <div className="flex flex-col justify-center items-center text-center">
                <h2 className="text-4xl font-extrabold">Artikel Terbaru</h2>
              </div>
